...
export default function WordPage() {
  ...
  const missionSequence = parseInt(searchParams.get("missionSequence") || "2", 10);
  ...
  // For word page, primary word and image come from the first visual item or task
  const primaryVisual = visualItems[0];
  const word = primaryVisual?.word || task?.word || "";
  const wordImage = primaryVisual?.image;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center gap-8">
        {/* StatusBox — renders as WordStatusBox (variable w/h, Figma paddings/gaps) */}
        {word && (
          <StatusBox
            text={word}
